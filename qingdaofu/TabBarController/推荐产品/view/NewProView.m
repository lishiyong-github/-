...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _aH = 54 + _nameH + self.moneyView.aH;
    }
    return self;
}
...
- (UILabel *)nameLabel
{
    if (!_nameLabel) {
        ...
        CGSize size = [_nameLabel.text sizeWithAttributes:@{NSFontAttributeName:kSecondFont}];
        _nameH = size.height;
    }
    return _nameLabel;
}
...
- (UIImageView *)recommendimageView
{
    if (!_recommendimageView) {
        ...
        _recommendimageView.backgroundColor = kBlueColor;
    }
