...
@implementation ReportSuitSeView
...
- (BaseLabel *)ssCell3
{
    if (!_ssCell3) {
        ...
        [_ssCell3.tButton setTitle:@"按月付息，到期还本" forState:0];
        [_ssCell3.tButton setTitleColor:kBlueColor forState:0];
    }
    return _ssCell3;
}
- (LineLabel *)ssLine3
...
- (BaseLabel *)ssCell4
{
    if (!_ssCell4) {
        ...
        [_ssCell4.tButton setTitleColor:kBlueColor forState:0];
        [_ssCell4.tButton setTitle:@"自然人" forState:0];
    }
    return _ssCell4;
}
...
- (BaseLabel *)ssCell5
{
    if (!_ssCell5) {
        ...
        [_ssCell5.tButton setTitleColor:kBlueColor forState:0];
        [_ssCell5.tButton setTitle:@"代理诉讼" forState:0];
    }
    return _ssCell5;
}
...
- (BaseLabel *)ssCell6
{
    if (!_ssCell6) {
        ...
        [_ssCell6.tButton setTitleColor:kBlueColor forState:0];
        [_ssCell6.tButton setTitle:@"1" forState:0];
    }
    return _ssCell6;
}
...
- (BaseLabel *)ssCell10
{
    if (!_ssCell10) {
        ...
        [_ssCell10.tButton setTitleColor:kBlueColor forState:0];
        [_ssCell10.tButton setTitle:@"分期" forState:0];
        _ssCell10.tButton.titleLabel.font = kSecondFont;
    }
    return _ssCell10;
}
...
- (BaseLabel *)ssCell11
{
    if (!_ssCell11) {
        ...
        [_ssCell11.tButton setTitleColor:kBlueColor forState:0];
        [_ssCell11.tButton setTitle:@"上传" forState:0];
        _ssCell11.tButton.titleLabel.font = kSecondFont;
    }
    return _ssCell11;
}
...
- (BaseLabel *)ssCell12
{
    if (!_ssCell12) {
        ...
        [_ssCell12.tButton setTitleColor:kBlueColor forState:0];
        [_ssCell12.tButton setTitle:@"完善" forState:0];
        _ssCell12.tButton.titleLabel.font = kSecondFont;
    }
    return _ssCell12;
}
...
- (BaseLabel *)ssCell13
{
    if (!_ssCell13) {
        ...
        [_ssCell13.tButton setTitleColor:kBlueColor forState:0];
        [_ssCell13.tButton setTitle:@"完善" forState:0];
        _ssCell13.tButton.titleLabel.font = kSecondFont;
    }
    return _ssCell13;
}
/*
