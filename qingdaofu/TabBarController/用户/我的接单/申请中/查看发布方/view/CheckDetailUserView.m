...
- (AuthenBaseView *)cellV2
{
    if (!_cellV2) {
        ...
        _cellV2.textField.placeholder = @"";
        _cellV2.textField.userInteractionEnabled = NO;
        _cellV2.button.titleLabel.font = kSecondFont;
        [_cellV2.button setTitleColor:kLightGrayColor forState:0];
    }
    return _cellV2;
}
- (LineLabel *)line2
...
- (AuthenBaseView *)cellV5
{
    if (!_cellV5) {
        ...
        _cellV5.textField.placeholder = @"";
        _cellV5.textField.userInteractionEnabled = NO;
        _cellV5.button.titleLabel.font = kSecondFont;
        [_cellV5.button setTitleColor:kLightGrayColor forState:0];
...
- (AuthenBaseView *)cellV6
{
    if (!_cellV6) {
        _cellV6 = [AuthenBaseView newAutoLayoutView];
        _cellV6.label.text = @"经典案例";
        _cellV6.textField.placeholder = @"";
        _cellV6.textField.userInteractionEnabled = NO;
        [_cellV6.button setTitle:@"查看 >" forState:0];
        _cellV6.button.titleLabel.font = kSecondFont;
        [_cellV6.button setTitleColor:kLightGrayColor forState:0];
    }
    return _cellV6;
}
