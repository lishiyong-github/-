...
- (UIImageView *)aImageView
{
    if (!_aImageView) {
        ...
        _aImageView.backgroundColor = kRedColor;
...
- (UIButton *)AuthenButton
{
    if (!_AuthenButton) {
        ...
        [_AuthenButton setTitleColor:[UIColor whiteColor] forState:0];
