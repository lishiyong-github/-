...
- (AuthenBaseView *)baseView1
{
    if (!_baseView1) {
        ...
        _baseView1.textField.placeholder = @"";
...
{
    if (!_baseView2) {
        _baseView2 = [[AuthenBaseView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, _baseView2.aH)];
...
{
    if (!_baseView3) {
        _baseView3 = [[AuthenBaseView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, _baseView3.aH)];
...
{
    if (!_baseView4) {
        _baseView4 = [[AuthenBaseView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, _baseView4.aH)];
...
{
    if (!_baseView5) {
        _baseView5 = [[AuthenBaseView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, _baseView5.aH)];
//        _baseView5.label.text = @"| 补充信息";
...
{
    if (!_baseView7) {
        _baseView7 = [[AuthenBaseView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, _baseView7.aH)];
